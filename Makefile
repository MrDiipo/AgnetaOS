FILES = ./build/kernel.asm.o ./build/kernel.o ./build/idt/idt.asm.o ./build/isr80h/misc.o ./build/idt/idt.o ./build/keyboard/keyboard.o ./build/keyboard/classic.o  ./build/isr80h/isr80h.o ./build/isr80h/io.o ./build/gdt/gdt.o ./build/gdt/gdt.asm.o  ./build/task/process.o ./build/task/task.asm.o ./build/task/tss.asm.o ./build/memory/memory.o ./build/disk/streamer.o  ./build/io/io.asm.o ./build/memory/heap/heap.o ./build/memory/heap/kheap.o  ./build/memory/paging/paging.o ./build/memory/paging/paging.asm.o ./build/disk/disk.o ./build/fs/pparser.o ./build/fs/file.o ./build/fs/fat16/fat16.o  ./build/string/string.o
INCLUDES = -I./src
...
./build/fs/fat/fat16.o: ./src/fs/fat/fat16.c
	i686-elf-gcc $(INCLUDES)  -I./src/fs -I./src/fat $(FLAGS) -std=gnu99 -c  ./src/fs/fat/fat16.c -o ./build/fs/fat16/fat16.o
